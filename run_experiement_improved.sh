...
if [ -z "$3" ]; then
    ${GEM5_BASE}/build/ARM/gem5.opt --debug-flags=BranchTrace --debug-start=0 --debug-file=${FIFO_NAME} -d ${GEM5_BASE}/m5out ${GEM5_BASE}/configs/project/configs/project/arm_simpoint_checkpoint.py --exp $1 &
else
    ${GEM5_BASE}/build/ARM/gem5.opt --debug-flags=BranchTrace --debug-start=0 --debug-file=${FIFO_NAME} -d ${GEM5_BASE}/m5out ${GEM5_BASE}/configs/project/configs/project/arm_simpoint_checkpoint.py --exp $1 < $3 &
fi
